    ...
    <div className="w-screen h-screen flex justify-center items-center">
        <div className="flex flex-col gap-10">
            <div className="flex flex-row gap-2">
                <h1 style={{ fontFamily: 'Montserrat' }} className='text-white text-2xl'>Ponto</h1>
                <h1 style={{ fontFamily: 'Montserrat' }} className='text-white text-2xl font-extrabold'>Ilumeo</h1>
            </div>
            <div className='flex flex-col gap-7'>
                <div style={{ backgroundColor: "#1E2733", borderRadius: "6px"}} className='flex flex-col px-4 py-2'>
                    ...
                    <input value={userCodInput.toLocaleUpperCase()} onChange={(i)=>setUserCodInput(i.target.value.toLocaleLowerCase())} style={{ fontFamily: 'Montserrat' }} id='user-cod-input' className= 'text-white font-bold bg-transparent border-none w-96 py-2' type={"text"}/>
                </div>
